...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MasterAreaControl.ascx.cs" Inherits="CSR.SharePointApplication.CONTROLTEMPLATES.HumasCSR.MasterAreaControl" %>
             ...
             <table id="tblMasterArea" class="tabelgrid">
                  <thead>                
                    <tr>   
                       ...
                       <th class="header-grid">Nama Area</th>
...
<script src="../../../_layouts/15/CSR.SharePointApplication/js/MasterArea.js" type="text/javascript"></script>
