...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReportExcelControl.ascx.cs" Inherits="CSR.SharePointApplication.CONTROLTEMPLATES.HumasCSR.ReportExcelControl" %>

<div class="border">
    <div id="wrapping" class="clearfix">
       <div class="title-h1">Laporan Excel</div>
        <div id="left-side">
         <div class="div">
